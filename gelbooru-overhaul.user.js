...
(function () {
	...
	function main() {
		...
		configManager.addUpdateListener(
			"advancedBlacklist.enable",
			applyTweakAdvancedBlacklist
		);
		configManager.addUpdateListener(
			"advancedBlacklist.hideMode",
			applyCssVariableBlacklist
		);
		configManager.addUpdateListener(
			"advancedBlacklist.hideFilter",
			applyCssVariableBlacklist
		);
		configManager.addUpdateListener(
			"advancedBlacklist.showOnHover",
			applyCssVariableBlacklist
		);
		configManager.addUpdateListener(
			"advancedBlacklist.enlargeOnHover",
			applyCssVariableBlacklist
		);
		configManager.addUpdateListener(
			"advancedBlacklist.entriesOrder",
			applyVariableBlacklist
		);

		configManager.addUpdateListener(
			"collapsibleSidebar.enable",
			applyTweakCollapseSidebar
		);
		configManager.addUpdateListener(
			"collapsibleSidebar.width",
			applyCssVariableGoCollapseSidebar
		);
		configManager.addUpdateListener(
			"collapsibleSidebar.color",
			applyCssVariableGoCollapseSidebar
		);
		configManager.addUpdateListener(
			"collapsibleSidebar.opacity",
			applyCssVariableGoCollapseSidebar
		);
		...
		configManager.addUpdateListener(
			"post.fitHorizontallyOnNarrow",
			applyTweakPostOnNarrow
		);
		configManager.addUpdateListener(
			"post.switchFitOnClick",
			applyTweakPostClickSwitchFit
		);
		configManager.addUpdateListener(
			"post.autoScroll",
		...
		configManager.addUpdateListener(
			"thumbs.resizeGallery",
			applyTweakResizeThumbsGallery
		);
		configManager.addUpdateListener(
			"thumbs.resizeGallerySize",
			applyCssVariableGoThumbnailResize
		);
		configManager.addUpdateListener(
			"thumbs.resizeMoreLikeThis",
			applyTweakResizeThumbsMoreLikeThis
		);
		configManager.addUpdateListener(
			"thumbs.resizeMoreLikeThisSize",
			applyCssVariableGoThumbnailResize
		);
		configManager.addUpdateListener(
			"thumbs.enlargeOnHover",
			applyTweakEnlargeOnHover
		);
		configManager.addUpdateListener(
			"thumbs.scale",
			applyCssVariableGoThumbnailEnlarge
		);
		configManager.addUpdateListener(
			"thumbs.highRes",
			applyTweakLoadHighRes
		);
		configManager.addUpdateListener(
			"thumbs.loader",
			applyTweakLoadingIndicator
		);
		configManager.addUpdateListener(
			"thumbs.removeTitle",
			applyTweakRemoveTitle
		);
		configManager.addUpdateListener(
			"thumbs.preventOffScreen",
			applyTweakPreventOffScreen
		);
		configManager.addUpdateListener(
			"thumbs.roundCorners",
			applyTweakRoundCorners
		);
		...
		configManager.addUpdateListener(
			...
			applyTweakInfiniteScroll
		);
		configManager.addUpdateListener(
			"infiniteScroll.paginatorOnTop",
			applyTweakPaginatorOnTop
		);
		configManager.addUpdateListener(
		...
		configManager.addUpdateListener("darkMode.amoled", (v) => {
			themeManager.checkForThemeSwitch(v);
		});

		infiniteScrolling.addUpdateListener((e) => {
			applyTweakEnlargeOnHover(
				Boolean(configManager.findValueByKey("thumbs.enlargeOnHover")),
				e
			);
			applyTweakLoadingIndicator(
				Boolean(configManager.findValueByKey("thumbs.loader")),
				e
			);
			applyTweakRoundCorners(
				Boolean(configManager.findValueByKey("thumbs.roundCorners")),
				e
			);
			applyTweakRemoveTitle(
				Boolean(configManager.findValueByKey("thumbs.removeTitle")),
				e
			);
			applyTweakFastDL(
				Boolean(configManager.findValueByKey("fastDL.thumbs")),
				e
			);

			applyTweakResizeThumbsGallery(
				Boolean(configManager.findValueByKey("thumbs.resizeGallery")),
				e
			);
			if (configManager.findValueByKey("advancedBlacklist.enable")) {
				e.forEach((e) =>
					e.parentElement.classList.add("go-blacklisted-pending")
				);
